...
DisconnectOutputCommand::DisconnectOutputCommand(std::shared_ptr<ConveyorManager> rec, size_t cI, size_t nI, std::shared_ptr<NodeOutputCard> card)
        :AConnectCommand<NodeOutputCard>(rec, cI, nI, card){
}
