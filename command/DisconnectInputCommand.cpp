...
DisconnectInputCommand::DisconnectInputCommand(std::shared_ptr<ConveyorManager> rec, size_t cI, size_t nI, std::shared_ptr<NodeInputCard> card)
        :AConnectCommand<NodeInputCard>(rec, cI, nI, card){
}
