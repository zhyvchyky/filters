...
DisconnectGaussianBlurCommand::DisconnectGaussianBlurCommand(std::shared_ptr<ConveyorManager> rec, size_t nI, size_t cI, std::shared_ptr<GaussianBlurCard> card)
