...
DisconnectColorGeneratorCommand::DisconnectColorGeneratorCommand(std::shared_ptr<ConveyorManager> rec, size_t cI, size_t nI, std::shared_ptr<ColorGeneratorCard> card)
        :AConnectCommand<ColorGeneratorCard>(rec, cI, nI, card){
}
